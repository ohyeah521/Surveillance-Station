...
PATCH_LIST="${PATCH_LIST:-"bin/ssctl bin/synosurv_backup bin/ssupgrader lib/libsscgi_1.so lib/libssbase.so lib/libsswebapicmssync.so lib/libssutils.so sbin/ssactruled sbin/sscmshostd sbin/sscored sbin/ssdaemonmonitord sbin/ssexechelperd sbin/ssroutined sbin/ssmessaged sbin/ssrtmpclientd webapi/Transactions/src/SYNO.SurveillanceStation.Transactions.so webapi/License/src/SYNO.SurveillanceStation.License.so webapi/Camera/src/SYNO.SurveillanceStation.Camera.so webapi/Layout/src/SYNO.SurveillanceStation.Layout.so webapi/CMS/src/SYNO.SurveillanceStation.CMS.so webapi/Stream/src/SYNO.SurveillanceStation.Stream.so webapi/AxisAcsCtrler/src/SYNO.SurveillanceStation.AxisAcsCtrler.so webapi/Info/src/SYNO.SurveillanceStation.Info.so webapi/IOModule/src/SYNO.SurveillanceStation.IOModule.so webapi/IPSpeaker/src/SYNO.SurveillanceStation.IPSpeaker.so webapi/UserPrivilege/src/SYNO.SurveillanceStation.UserPrivilege.so webapi/DualAuth/src/SYNO.SurveillanceStation.DualAuth.so"}"
