...
PATCH_LIST="${PATCH_LIST:-"lib/libssffmpegutils.so lib/libssutils.so sbin/sscmshostd sbin/ssapid sbin/sscored sbin/sscamerad sbin/ssdaemonmonitord sbin/ssexechelperd sbin/ssroutined sbin/ssmessaged sbin/ssrtmpclientd webapi/Camera/src/SYNO.SurveillanceStation.Camera.so"}"
