...
PATCH_LIST="${PATCH_LIST:-"lib/libssffmpegutils.so lib/libssutils.so sbin/ssnotifyd sbin/sscmshostd sbin/sscored sbin/sscamerad sbin/ssdaemonmonitord sbin/ssexechelperd sbin/ssroutined sbin/ssmessaged sbin/ssrtmpclientd  sbin/sswebstreamd webapi/Camera/src/SYNO.SurveillanceStation.Camera.so"}"
