...
PATCH_LIST="${PATCH_LIST:-"lib/libssutils.so sbin/sscmshostd sbin/sscored sbin/ssdaemonmonitord sbin/ssexechelperd sbin/ssroutined sbin/ssmessaged sbin/ssrtmpclientd"}"
