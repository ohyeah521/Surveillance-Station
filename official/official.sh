...
PATCH_LIST="${PATCH_LIST:-"bin/ssctl  lib/libssutils.so sbin/ssactruled sbin/sscmshostd sbin/sscored sbin/sscamerad sbin/ssdaemonmonitord sbin/ssexechelperd sbin/ssroutined sbin/ssmessaged sbin/ssrtmpclientd webapi/Camera/src/SYNO.SurveillanceStation.Camera.so"}"  
